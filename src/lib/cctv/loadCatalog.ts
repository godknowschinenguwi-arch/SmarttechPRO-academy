...
import { cameraStore, nvrStore, hddStore, cableStore, poeSwitchStore } from './catalogDb';
...
export async function getActiveCctvCatalog(): Promise<CctvCatalog> {
  try {
    ...
    return { cameras: CAMERAS, nvrs: NVRS, hdds: HDDS, cables: CABLES, poeSwitches: POE_SWITCHES };
  }
}
